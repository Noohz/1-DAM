...
public class CalculadoraFinanciera {	
	...
	public boolean validarTasa(String tasa) throws EconomiaException{
		...
		if (valorRetorno==false) {
			throw new EconomiaException("Error en la eleción de la tasa de actualización!");
		}
		return valorRetorno;
	
	}
	
	public DatosUsuario perdirDatosInversion() throws EconomiaException{
	...
	public static void main(String[] args) throws EconomiaException{
